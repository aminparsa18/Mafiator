...
namespace MafiatorApp.UserControls.ImageCropper
{
    ...
    public sealed class ImageCropView : ContentView
    {
        /// <summary>
...
#pragma warning restore 0219
        ...
        {
            get => (IList<ITransformation>)GetValue(TransformationsProperty);
        ...
        {
            get => (IList<ITransformation>)GetValue(PreviewTransformationsProperty);
            set => SetValue(PreviewTransformationsProperty, value);
        }

        public static readonly BindableProperty AspectProperty = BindableProperty.Create(nameof(Aspect), typeof(Aspect), typeof(ImageCropView), Aspect.Fill);          public Aspect Aspect
        ...
        {
            get => (View)GetValue(FrameViewProperty);
        ...
        {
            get => (double)GetValue(PanSpeedProperty);
        ...
        {
            get => (double)GetValue(ManualZoomProperty);
        ...
        {
            get => (double)GetValue(ManualOffsetXProperty);
        ...
        {
            get => (double)GetValue(ManualOffsetYProperty);
        ...
        {
            get => (int)GetValue(PreviewMaxResolutionProperty);
        ...
        {
            get => (int)GetValue(RefinedMaxResolutionProperty);
        ...
        {
            get => (bool)GetValue(TouchGesturesEnabledProperty);
        ...
        {
            get => (int)GetValue(ImageRotationProperty);
