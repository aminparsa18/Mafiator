    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(26)", nullable: false),
                    PersianCaption = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(26)", nullable: false),
                    EventId = table.Column<string>(type: "nvarchar(26)", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(26)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "(getDate())"),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "(getDate())")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventJoin", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EventJoin_Event",
                        column: x => x.EventId,
                        principalSchema: "dbo",
            ...
            migrationBuilder.CreateTable(
                name: "GameViolationReport",
                schema: "dbo",
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(26)", nullable: false),
                    GameId = table.Column<string>(type: "nvarchar(26)", nullable: false),
                    ReporterId = table.Column<string>(type: "nvarchar(26)", nullable: false),
                    ReportedId = table.Column<string>(type: "nvarchar(26)", nullable: false),
                    ViolationType = table.Column<short>(type: "smallint", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "(getDate())"),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "(getDate())")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameViolationReport", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GameViolationReport_Game",
                        column: x => x.GameId,
                        principalSchema: "dbo",
                        principalTable: "Game",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameViolationReport_Reported",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GameViolationReport_Reporter",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventJoin_EventId",
                schema: "dbo",
                table: "EventJoin",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_EventJoin_UserId",
                schema: "dbo",
                table: "EventJoin",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameViolationReport_GameId",
                schema: "dbo",
                table: "GameViolationReport",
                column: "GameId");

            migrationBuilder.CreateIndex(
                name: "IX_GameViolationReport_ReportedId",
                schema: "dbo",
                table: "GameViolationReport",
                column: "ReportedId");

            migrationBuilder.CreateIndex(
                name: "IX_GameViolationReport_ReporterId",
                schema: "dbo",
                table: "GameViolationReport",
                column: "ReporterId");
