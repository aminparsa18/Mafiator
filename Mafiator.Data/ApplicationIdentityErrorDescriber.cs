...
namespace Mafiator.Data
{
    public class ApplicationIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        public override IdentityError InvalidEmail(string email)=> new IdentityError { Code = nameof(InvalidEmail), Description = "ایمیل وارد شده نادرست است" };
        ...
        public override IdentityError PasswordMismatch() => new IdentityError { Code = nameof(PasswordMismatch), Description = "گذرواژه شما نادرست است" };
