...
public partial class JoinRoomViewModel : ViewModelBase
{
    ...
    {
        await _navigationService.NavigateToPopupAsync<WaitingViewModel>(LocalizationResourceManager.Instance["JoiningRoom"]);
    ...
    [RelayCommand]
    private async Task ScanBarcode() => await _navigationService.NavigateToAsync(nameof(BarcodeScannerViewModel));
