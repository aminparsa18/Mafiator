...
public class ExtendedEntry : Entry
{
    ...
    public static readonly BindableProperty LineColorProperty =
        BindableProperty.Create(nameof(LineColor), typeof(Color), typeof(ExtendedEntry), Colors.Transparent);
    ...
    public static readonly BindableProperty InvalidLineColorProperty =
        BindableProperty.Create("InvalidLineColor", typeof(Color), typeof(ExtendedEntry), Colors.Transparent);
    ...
    {
        return LineColor != Colors.Transparent
                ? LineColor
                : TextColor;
    }
}